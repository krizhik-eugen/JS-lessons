...
export const rejectPromise = () => {
    handlePromise.reject && handlePromise.reject('1')
}
...
/*const namePr7 = new Promise((res, rej) => {
    setTimeout(() => {
        res({name: 'Anna'})
    }, 2000)
})
const agePr7 = new Promise((res, rej) => {
    setTimeout(() => {
        res({age: 16})
    }, 3000)
})
const cityPr7 = new Promise((res, rej) => {
    setTimeout(() => {
        res({city: ''})
    }, 4000)
})

const res = Promise.all([namePr7, agePr7, cityPr7]).then(res => {
